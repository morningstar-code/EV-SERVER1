...
const configData = [
  ...
  (garages = {
    ...
    data: [
      ...
      {
        garage_id: 'air_a',
        name: 'LS Airport Garage',
        type: 'public',
        hidden: true,
        parking_limit: 10,
        location: {
          vectors: { x: -1631.41, y: -3143.26, z: 13.99 },
          length: 9.6,
          width: 6.0,
          options: {
            heading: 330,
        ...
        parking_spots: [
          {
            ...
            distance: 1.2,
            heading: 330,
            coords: { x: -1631.41, y: -3143.26, z: 13.99 },
          },
        ],
      },
      {
        ...
        parking_spots: [
          {
            ...
            distance: 2,
            heading: 89,
            coords: { x: 445.827, y: -996.969, z: 24.7 },
          },
          {
            type: 'land',
            size: 2,
            distance: 2,
            heading: 89,
            coords: { x: 445.815, y: -994.269, z: 24.7 },
          },
          {
            type: 'land',
            size: 2,
            distance: 2,
            heading: 89,
            coords: { x: 445.802, y: -991.568, z: 24.7 },
          },
          {
            type: 'land',
            size: 2,
            distance: 2,
            heading: 89,
            coords: { x: 445.79, y: -988.868, z: 24.7 },
          },
          {
            type: 'land',
            size: 2,
            distance: 2,
            heading: 89,
            coords: { x: 445.778, y: -986.168, z: 24.7 },
          },
          {
            type: 'land',
            size: 2,
            distance: 2,
            heading: 268,
            coords: { x: 437.493, y: -986.143, z: 24.7 },
          },
          {
            type: 'land',
            size: 2,
...
function GetConfig(src) {
 ...
 /*  const discordId = global.exports.zdiscord.getDiscordId(src);
  const hasSilver = global.exports.zdiscord.isRolePresent(discordId, '9');
  const hasGold = global.exports.zdiscord.isRolePresent(discordId, '9');
  const hasCarbon = global.exports.zdiscord.isRolePresent(discordId, '9');
  const hasStaff = global.exports.zdiscord.isRolePresent(discordId, '999');
  const hasDirector = global.exports.zdiscord.isRolePresent(discordId, '1132086373671780457');
...
RPC.register('ev-config:getClientConfig', async () => {
  let src = source;

...
RegisterUICallback("ev-ui:getCharacterPermissions", function(data, cb)
  local success, message = RPC.execute("GetStateAccess")
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("ev-ui:getStateCharacterDetails", function(data, cb)
  local success, message = RPC.execute("GetCharacterDetails", data)
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("ev-ui:revokeLicense", function(data, cb)
...
RegisterUICallback("ev-ui:grantLicense", function(data, cb)

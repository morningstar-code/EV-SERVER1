...
export const DB = {
    execute: <T>(pQuery: string, pParams: any): T => {
        return APX.DB.execute(pQuery, pParams);
    },
    insert: (pQuery: string, pParams: any) => {
        return APX.DB.insert(pQuery, pParams);
    },
    prepare: (pQuery: string, pParams: any) => {
        return APX.DB.prepare(pQuery, pParams);
    },
    query: (pQuery: string, pParams: any) => {
        return APX.DB.query(pQuery, pParams);
    },
    scalar: (pQuery: string, pParams: any) => {
        return APX.DB.scalar(pQuery, pParams);
    },
    single: (pQuery: string, pParams: any) => {
        return APX.DB.single(pQuery, pParams);
    },
    transaction: (pQuery: string, pParams: any) => {
        return APX.DB.transaction(pQuery, pParams);
    },
    update: (pQuery: string, pParams: any) => {
        return APX.DB.update(pQuery, pParams);
    }
}
...
export const Zones = {
    isActive: (zone: string, data = {} as any) => {
...
export const Hud = {
    ...
    applyBlipSettings: (blip: any, blipName: string, p2: any, p3: any, p4?: any, p5?: any, p6?: any, p7?: any) => {
        return CPX.Hud.applyBlipSettings(blip, blipName, p2, p3, p4, p5, p6, p7);
    }
}
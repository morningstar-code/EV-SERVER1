...
const ClothingInput: FunctionComponent = (props: any) => {
    ...
    const handleChange = (newTextureId: number) => {
        ...
        const whitelistedClothing = props?.whitelistedClothing?.[props.gender]?.[props.enum]?.find(clothing => clothing.componentId === componentId && (clothing.textureId === undefined || clothing.textureId === newTextureId));

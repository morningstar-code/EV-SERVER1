...
class App extends React.Component<{}, { hasError: boolean, restart: boolean, errorHandle: boolean }>{
  ...
  componentDidMount() {
    ...
    if (isEnvBrowser()) {
      ...
      //             options: [
      //               {
      //                 title: "I GOT CHILDREN",
      //                 description: "YOOOOOOO",
      //                 icon: "user-secret",
      //                 children: [
      //                   {
      //                     title: "LE BOZO",
      //                     description: "Potato and slump both bozos",
      //                     icon: "user",
      //                     disabled: false,
      ...
      //         data: {
      //           pages: [
      //             "https://i.imgur.com/A26wAo1.png", 
      //             "https://i.imgur.com/kwskDAz.png", 
      //             "https://i.imgur.com/CjVomBp.png", 
      //             "https://i.imgur.com/kwskDAz.png", 
      //             "https://i.imgur.com/CjVomBp.png", 
      //             "https://i.imgur.com/kwskDAz.png", 
      //             "https://i.imgur.com/CjVomBp.png", 
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo): void {
    ...
    console.log('---- COOL INTERFACE CATASTROPHIC ERROR -----');

...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev, skipRagdoll)
  ...
  while tbsListening do
    ...
    if IsPedRagdoll(GetPed()) and not skipRagdoll then
      tbsListening = false
      minigameResult = 0
    end

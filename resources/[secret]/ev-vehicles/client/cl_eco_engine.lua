...
Citizen.CreateThread(function()
  exports["ev-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Eco Mode", "+toggleEcoMode", "-toggleEcoMode")
end)

function isCopVehicle(pVehicle)
  local policeVehicles = exports["ev-config"]:GetModuleConfig("ev-police").policeVehicles

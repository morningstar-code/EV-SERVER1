...
local function cleanVehicle()
    ...
    local clean = RPC.execute("ev-carwash:cleanVehicle")
...
AddEventHandler("ev-polyzone:enter", function(zone)
    ...
    exports["ev-ui"]:showInteraction("[E] Clean the Vehicle for $100")
    listenForKeypress()
end)
...
Citizen.CreateThread(function()
    -- Strawberry
    exports["ev-polyzone"]:AddBoxZone("car_wash", vector3(26.59, -1392.02, 27.36), 3.0, 3.0, {
        heading=0,
        minZ=25.00,
        maxZ=32.00,
    })
    ...
    -- Davis
    exports["ev-polyzone"]:AddBoxZone("car_wash", vector3(175.03, -1736.63, 29.29), 6.0, 6.0, {
        heading=0,
        minZ=25.00,
        maxZ=32.00,
    })
    ...
    -- Little Seoul
    exports["ev-polyzone"]:AddBoxZone("car_wash", vector3(-699.96, -933.30, 19.01), 6.0, 6.0, {
        heading=0,
        minZ=18.00,
        maxZ=22.00,
    })
    ...
    -- Sandy Shores
    exports["ev-polyzone"]:AddBoxZone("car_wash", vector3(1362.53, 3592.12, 33.92), 6.0, 6.0, {
        heading=115,
        minZ=33.00,
        maxZ=38.00,
    })

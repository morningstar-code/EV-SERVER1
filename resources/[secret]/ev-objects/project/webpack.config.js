...
const server = () => ({
    entry: ['./src/server/server.ts', './src/server/controllers/events.ts'],
    output: {
...
const client = () => ({
    entry: ['./src/client/client.ts', './src/client/controllers/events.ts', './src/client/controllers/groupselect.ts', './src/client/controllers/multiplacement.ts', './src/client/controllers/placement.ts'],
    output: {

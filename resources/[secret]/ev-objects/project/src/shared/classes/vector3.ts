export class Vector3 {
    ...
    addPlusScaler(pCoords: Vector3, pValue: number) {
        this.x += pCoords.x * pValue;
        this.y += pCoords.y * pValue;
        this.z += pCoords.z * pValue;
        return this;
    }
    subPlusScaler(pCoords: Vector3, pValue: number) {
        this.x -= pCoords.x * pValue;
        this.y -= pCoords.y * pValue;
        this.z -= pCoords.z * pValue;
        return this;
    ...
    isCoordinateEqual(pCoord1: Vector3, pCoord2: Vector3) {
        return pCoord1.equals(pCoord2);
    }
    static fromArray(pCoords: number[]) {
        return new Vector3(pCoords[0], pCoords[1], pCoords[2]);
    }
    static fromObject(pCoords: { x: number; y: number; z: number }) {

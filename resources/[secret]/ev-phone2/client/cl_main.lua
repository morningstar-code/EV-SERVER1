...
--             has_usb_racing_create = false, --hasRaceUsbAndAlias.has_usb_racing_create,
--             has_usb_racing = false, --hasRaceUsbAndAlias.has_usb_racing,
--             has_usb_pd_racing = false, --hasRaceUsbAndAlias.has_usb_pd_racing,
--             racing_alias = nil, --hasRaceUsbAndAlias.racingAlias,

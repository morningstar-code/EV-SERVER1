RegisterUICallback("ev-ui:smsSend", function(data, cb)
...
RegisterUICallback("ev-ui:getMessages", function(data, cb)
...
AddEventHandler("phone:readPlayerconversations", function(pServerId)
  ...
  if pServerId ~= nil then
    ...
    if success then
      ...
      exports["ev-ui"]:openApplication("burner", { source_number  = pPhoneNumber, isOwner = false })
    end
  end
end)